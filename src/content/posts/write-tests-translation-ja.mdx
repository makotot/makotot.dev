...
<div className="flex justify-center">
  <blockquote className="twitter-tweet">
    <p lang="en" dir="ltr">
      ...
      <br />
      <br />
      Our tools are awesome now and this assumption is less true. This is why I say
      goodby to the pyramid 🔼 and hello to the trophy 🏆 <a href="https://t.co/EKTK4vqj6n">
        https://t.co/EKTK4vqj6n
      </a> <a href="https://t.co/Wa8brUiWfy">pic.twitter.com/Wa8brUiWfy</a>
    </p>
    &mdash; Kent C. Dodds 🌌 (@kentcdodds) <a href="https://twitter.com/kentcdodds/status/1141365123296051201?ref_src=twsrc%5Etfw">June 19, 2019</a>
  </blockquote>{" "}
  <script async src="https://platform.twitter.com/widgets.js" charSet="utf-8"></script>
</div>
...
<div className="flex justify-center">
  <blockquote className="twitter-tweet">
    ...
    &mdash; Kent C. Dodds 🌌 (@kentcdodds) <a href="https://twitter.com/kentcdodds/status/960723172591992832?ref_src=twsrc%5Etfw">February 6, 2018</a>
  </blockquote>{" "}
  <script async src="https://platform.twitter.com/widgets.js" charSet="utf-8"></script>
</div>
...
<div className="flex justify-center">
  <blockquote className="twitter-tweet">
    ...
    &mdash; Erin 🐠 (@erinfranmc) <a href="https://twitter.com/erinfranmc/status/1148986961207730176?ref_src=twsrc%5Etfw">July 10, 2019</a>
  </blockquote>{" "}
  <script async src="https://platform.twitter.com/widgets.js" charSet="utf-8"></script>
</div>
